...
public interface IPhysicalStatsModifyEffect {
     ...
     *
     * @param instigator The instigator who is applying this modifier on the entity. It can be another entity,
     *         block, item, etc.
     ...
     *         will be applied on the entity. For permanent modifiers, see {@link #applyMod(EntityRef, EntityRef,
