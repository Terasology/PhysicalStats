...
/**
 * This component is used for storing information about an entity's base physical stats or attributes. It's up to other
 * modules to define how exactly each stat is used - the descriptions given here are guidelines.
 */
