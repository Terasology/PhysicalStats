...
public class OnPhysicalStatsModifierRemovedEvent implements Event {
    ...
    public OnPhysicalStatsModifierRemovedEvent() {
    ...
    public OnPhysicalStatsModifierRemovedEvent(EntityRef instigator, EntityRef character, PhysicalStatsModifierComponent pModifier) {
        this.instigator = instigator;
        this.character = character;
